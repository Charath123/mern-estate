    ...
    <main className="m-5">
      ...
      {listing && !loading && !error && (
        <div>
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 border w-15 h-15 rounded-md p-3 flex justify-center items-center bg-slate-200 cursor-pointer ">
              Link Copied
            </p>
          )}
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            {currentUser && listing.userRef !== currentUser._id && !contact && (
              <button
                className="bg-slate-600 text-white rounded-lg uppercase p-3 hover:opacity-90"
                onClick={() => setContact(true)}
              >
                Contact Landlord
              </button>
